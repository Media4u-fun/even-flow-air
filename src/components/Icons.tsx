// Simple SVG icons used throughout the site
// No external icon library needed - keeps the bundle small
...
export function IconPaintbrush({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export function IconChevronRight({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export function ServiceIcon({ name, className = "w-8 h-8" }: { name: string; className?: string }) {
  const Icon = iconMap[name] || IconStar;
